...
class CreateGetTodayDueTasks extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure = <<<'PROCEDURE'
        CREATE DEFINER=`root`@`localhost` PROCEDURE `GetTodayDueTasks`(
            IN userId INT,
            IN currentDate DATE
          )
          BEGIN
    ...
    public function down()
    {
        ...
        DB::unprepared('DROP PROCEDURE IF EXISTS `GetTodayDueTasks`');
    }
}
